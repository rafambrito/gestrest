...
public interface TipoUsuarioControllerDoc {
    ...
    ResponseEntity<TipoUsuarioResponseDTO> criar(
            @RequestBody(
                    description = "Dados para criação de um novo tipo de usuário",
                    required = true,
                    content = @Content(
                            mediaType = "application/json",
                            schema = @Schema(implementation = TipoUsuarioRequestDTO.class),
                            examples = @ExampleObject(
                                    name = "Exemplo de criação tipo de usuário",
                                    value = """
                                        {
    ...
    @Operation(
            ...
            description = "Retorna uma lista com todos os tipos de usuários cadastrados"
    )
    @ApiResponse(
            responseCode = "200",
    ...
    ResponseEntity<TipoUsuarioResponseDTO> atualizar(
            ...
            @RequestBody(
                    ...
                    content = @Content(
                            ...
                            schema = @Schema(implementation = TipoUsuarioRequestDTO.class),
                            examples = @ExampleObject(
                                    name = "Exemplo de atualização tipo de usuário",
                                    value = """
                                        {
                                          "nome": "Administrador"
                                        }
