...
public interface UsuarioControllerDoc {
	...
	ResponseEntity<UsuarioResponseDTO> buscarPorId(@Parameter(description = "ID do usuário", example = "1") Long id);
	...
	ResponseEntity<List<UsuarioResponseDTO>> buscarPorNome(
			@Parameter(description = "Filtro por nome", example = "rafa") String nome);
}
